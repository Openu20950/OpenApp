...
public class RecommendationsListViewAdapter  extends ArrayAdapter<RecommendationImp> {
    // Declare Variables
    Context context;
    LayoutInflater inflater;
    List<RecommendationImp> reclist;
    //private SparseBooleanArray mSelectedItemsIds;

    public RecommendationsListViewAdapter(Context context, int resourceId,
                                          List<RecommendationImp> recommendationList) {
    ...
    public List<RecommendationImp> getPlaces() {
        return reclist;
    }
